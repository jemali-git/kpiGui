...
public class TabLabel extends Application {
	...
	public static void main(String[] args) {
		Application.launch(TabLabel.class, args);
	}
	...
	public void start(Stage primaryStage) {
		...
		Tab tabSize = new Tab();
		tabSize.setGraphic(new Circle(0, 0, 10));
	...
	/*
	 * Creates the UI for the sizing sample, which demonstrates ways to manage the
	 * size of controls when you don't want the default sizes.
	 */
	private Pane sizingSample() {
		...
		ObservableList<String> items = FXCollections.observableArrayList("Hot dog", "Hamburger", "French fries",
